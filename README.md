...
- Place a hotpocket contract named **contract_template** (Copies of this contract will be made when new instances are created) inside the **dependencies** directory. This should be a new contract (Created by `hpcore new`). In the future this will be placed by the installation process.
