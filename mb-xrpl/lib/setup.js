    ...
    async burnMintedNfts(xrplAcc) {
        ...
        try {
            ...
            for (const instance of instances) {
                const nftTokenId = instance.container_name;
                ...
                //await xrplAcc.burnNft(nftTokenId);
                console.log(`Burnt sold hosting NFT (${nftTokenId}) of ${instance.tenant_xrp_address} tenant account`);
            }
        }
        finally {
            db.close();
