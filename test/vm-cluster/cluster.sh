...
if [ $mode == "reconfig" ]; then
    ...
    install="curl -fsSL https://sthotpocket.blob.core.windows.net/evernode/setup.sh | cat  | SKIP_SYSREQ=1 bash -s install -q auto auto 1000000 1000000 2097152 3145728 3 Auto_\$HOSTNAME"
